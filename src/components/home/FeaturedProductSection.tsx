        ...
        <section className="bg-white py-16 md:py-24 overflow-hidden">
            <div className="container mx-auto px-4">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    {/* Image Content */}
                    <div className="relative min-h-[450px] md:min-h-[550px] animate-fade-in order-1 md:order-2" style={{ animationDelay: '0.2s' }}>
                        <div className="absolute inset-0 md:inset-auto md:top-0 md:bottom-0 md:-left-20 md:w-full group">
                            <img 
                            ...
                            <div 
                                className="absolute bottom-4 left-4 right-4 md:left-4 md:right-auto bg-white/80 backdrop-blur-sm p-3 rounded-xl shadow-lg flex items-center gap-3 transition-all duration-300 transform md:group-hover:scale-105 md:group-hover:shadow-xl"
                            >
                                <img 
