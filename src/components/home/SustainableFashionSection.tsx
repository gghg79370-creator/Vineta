...
export const SustainableFashionSection = ({ navigateTo }: SustainableFashionSectionProps) => (
    <section className="py-20 bg-brand-subtle overflow-hidden">
        <div className="container mx-auto px-4">
            <div className="relative flex items-center justify-end min-h-[500px]">
                ...
                <div className="relative md:absolute left-0 w-full md:w-1/2 bg-surface/80 backdrop-blur-sm p-8 md:p-12 rounded-2xl shadow-xl text-right animate-fade-in-up border border-surface">
