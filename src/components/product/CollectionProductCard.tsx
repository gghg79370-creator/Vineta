...
import { EyeIcon, HeartIcon, StarIcon, CompareIcon, ShoppingBagIcon } from '../icons';
...
export const CollectionProductCard: React.FC<CollectionProductCardProps> = ({ product, navigateTo, addToCart, openQuickView, compareList, addToCompare, wishlistItems, toggleWishlist }) => {
        ...
        <div className="group text-center bg-white rounded-2xl overflow-hidden border border-gray-100 transition-all duration-300 hover:shadow-lg h-full flex flex-col">
            <div className="relative">
                ...
                <div className="absolute top-4 right-4 space-y-2 z-10">
                     {product.isNew && <div className="bg-[#EFEFFD] text-[#6366F1] text-xs font-bold px-3 py-1.5 rounded-full shadow-sm">رائج</div>}
                </div>
                ...
                <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center justify-center gap-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
