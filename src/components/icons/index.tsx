...
const getClasses = ({ className, size = 'md', color }: IconProps) => `${sizeClasses[size]} ${color || ''} ${className || ''}`;
...
export const GiftIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={getClasses(props)} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 10h.01M15 10h.01M10 14a2 2 0 014 0h-4z" />
    </svg>
);
...
export const HeartIcon: React.FC<IconProps & { filled?: boolean }> = ({ filled, ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={getClasses(props)} fill={filled ? 'currentColor' : 'none'} viewBox="0 0 24 24" stroke="currentColor" strokeWidth={filled ? 0 : 2}>
...
export const GridViewIcon: React.FC<IconProps & { columns: number }> = ({ columns, ...props }) => {
    ...
    if (columns === 2) return (
         <svg xmlns="http://www.w3.org/2000/svg" className={getClasses(props)} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M4 6h5v5H4zM15 6h5v5h-5zM4 15h5v5H4zM15 15h5v5h-5z" />
        </svg>
    )
