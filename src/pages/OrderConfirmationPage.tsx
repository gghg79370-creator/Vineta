        ...
        <div className="bg-white py-20">
            <div className="container mx-auto px-4 text-center">
                ...
                <div className="flex justify-center items-center gap-4">
                    ...
                    <button onClick={() => navigateTo('account')} className="bg-white border border-brand-border text-brand-dark font-bold py-3 px-8 rounded-full hover:bg-brand-subtle">
                        عرض الطلبات
                    </button>
                </div>
            </div>
